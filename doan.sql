...
--
-- Host: localhost:3306
-- Generation Time: Sep 16, 2026 at 02:02 AM
...
(38, 48, 60, 1, 9800.00, 9800.00, NULL),
(39, 49, 11, 1, 550000.00, 550000.00, NULL),
(40, 50, 34, 1, 5000.00, 5000.00, NULL),
(41, 51, 21, 1, 322000.00, 322000.00, NULL),
(42, 52, 27, 1, 442000.00, 442000.00, NULL),
(43, 52, 108, 1, 249000.00, 249000.00, NULL),
(44, 53, 39, 15, 25000.00, 375000.00, NULL),
(45, 53, 80, 1000, 42999.00, 42999000.00, NULL),
(46, 54, 13, 8, 180000.00, 1440000.00, NULL),
(47, 54, 61, 1000, 11299.00, 11299000.00, NULL),
(48, 55, 2, 15, 25000.00, 375000.00, NULL),
(49, 55, 22, 15, 441000.00, 6615000.00, NULL),
(50, 56, 30, 20, 17000.00, 340000.00, NULL),
(51, 57, 108, 3, 249000.00, 747000.00, NULL),
(52, 58, 24, 1, 120000.00, 120000.00, NULL);
...
(20, 18, 60, NULL, 1, 9800.00, 9800.00),
(21, 19, 11, NULL, 1, 550000.00, 550000.00),
(22, 20, 34, NULL, 1, 5000.00, 5000.00),
(23, 21, 21, NULL, 1, 322000.00, 322000.00),
(24, 22, 27, NULL, 1, 442000.00, 442000.00),
(25, 22, 108, NULL, 1, 249000.00, 249000.00),
(26, 23, 39, NULL, 15, 25000.00, 375000.00),
(27, 23, 80, NULL, 1000, 42999.00, 42999000.00),
(28, 24, 13, NULL, 8, 180000.00, 1440000.00),
(29, 24, 61, NULL, 1000, 11299.00, 11299000.00),
(30, 25, 2, NULL, 15, 25000.00, 375000.00),
(31, 25, 22, NULL, 15, 441000.00, 6615000.00),
(32, 26, 30, NULL, 20, 17000.00, 340000.00),
(33, 27, 108, NULL, 3, 249000.00, 747000.00),
(34, 28, 24, NULL, 1, 120000.00, 120000.00);
...
INSERT INTO `danhmuc` (`madanhmuc`, `parent_id`, `tendanhmuc`, `hinhanh`) VALUES
(1, 28, 'Bìa hồ sơ', 'folders.png'),
(2, NULL, 'Bảng tên, dây đeo', 'employee.png'),
(3, NULL, 'Máy tính', 'calculations.png'),
(4, 28, 'Thước kẻ', 'ruler.png'),
(5, NULL, 'Balo', 'balo.png'),
(6, NULL, 'Giày', 'shoes.png'),
(7, 27, 'Sổ', 'notebook.png'),
(8, 26, 'Bút bi', '20200615084636-but.png'),
(9, 26, 'Bút kí', 'stationery.png'),
(10, 26, 'Bút lông', 'stationery-2.png'),
(11, 27, 'Giấy ghi nhớ', 'post-it.png'),
(12, 28, 'Hộp dấu ', 'stamp.png'),
(13, 28, 'Hình dán', 'happy.png'),
(14, 28, 'Dao rọc giấy', 'cutter.png'),
(15, 28, 'Bấm kim', 'stapler.png'),
(16, 28, 'Băng keo', 'tape.png'),
(17, 26, 'Bút Chì', 'color-pencil.png'),
(18, 27, 'Vở', 'notebook-1.png'),
(19, 27, 'Giấy các loại', 'papers.png'),
(26, NULL, 'Bút viết', NULL),
(27, NULL, 'Giấy & Vở', NULL),
(28, NULL, 'Văn phòng phẩm', NULL);
...
(47, 25, '2026-04-26', 32000.00, 'Hoàn thành'),
(48, 1, '2026-04-27', 8330.00, 'Hoàn thành'),
(49, 25, '2026-04-29', 550000.00, 'Đang giao'),
(50, 25, '2026-04-29', 5000.00, 'Chờ xác nhận'),
(51, 30, '2026-04-30', 322000.00, 'Đang giao'),
(52, 25, '2026-05-04', 691000.00, 'Hoàn thành'),
(53, 25, '2026-05-13', 43374000.00, 'Hoàn thành'),
(54, 1, '2026-05-13', 12739000.00, 'Đã hủy'),
(55, 2, '2026-05-16', 6990000.00, 'Đang giao'),
(56, 25, '2026-06-01', 340000.00, 'Đang giao'),
(57, 2, '2026-06-01', 634950.00, 'Chờ xác nhận'),
(58, 2, '2026-06-01', 120000.00, 'Chờ xác nhận');
...
(18, 1, 48, '2026-04-27', 8330.00, 'COD', 'Chưa thanh toán', ''),
(19, 25, 49, '2026-04-29', 550000.00, 'Chuyển khoản', 'Chờ xác nhận', ''),
(20, 25, 50, '2026-04-29', 5000.00, 'COD', 'Chưa thanh toán', ''),
(21, 30, 51, '2026-04-30', 322000.00, 'COD', 'Chưa thanh toán', ''),
(22, 25, 52, '2026-05-04', 691000.00, 'COD', 'Đã thanh toán', ''),
(23, 25, 53, '2026-05-13', 43374000.00, 'COD', 'Chưa thanh toán', ''),
(24, 1, 54, '2026-05-13', 12739000.00, 'COD', 'Chưa thanh toán', ''),
(25, 2, 55, '2026-05-16', 6990000.00, 'COD', 'Chưa thanh toán', ''),
(26, 25, 56, '2026-06-01', 340000.00, 'COD', 'Chưa thanh toán', ''),
(27, 2, 57, '2026-06-01', 634950.00, 'COD', 'Chưa thanh toán', ''),
(28, 2, 58, '2026-06-01', 120000.00, 'COD', 'Chưa thanh toán', '');
...
(30, 'BAAAA', 'BÊNNE', '0239999999', '0239999999', '123456', NULL, NULL, NULL, NULL, '2026-04-30 11:22:44', 'Cá nhân'),
(31, 'ffff', NULL, '0123457899', '0123457899', '123', NULL, NULL, NULL, NULL, '2026-05-16 10:55:44', 'Cá nhân'),
(32, 'user10', NULL, '', 'truc@gmail.com', '234', NULL, NULL, NULL, NULL, '2026-06-01 11:51:54', 'Cá nhân');
...
INSERT INTO `khachhang_voucher` (`id`, `makh`, `id_voucher`, `trang_thai`, `ngay_luu`) VALUES
(1, 2, 2, 1, '2026-06-01 11:53:47');
...
CREATE TABLE `quangcao` (
  ...
  `vi_tri` enum('banner_top','banner_home','banner_home_2','banner_home_3','popup','sidebar') COLLATE utf8mb4_unicode_ci DEFAULT 'banner_home',
...
INSERT INTO `quangcao` (`id`, `ten_qc`, `hinh_anh`, `link`, `vi_tri`, `mo_ta`, `trang_thai`, `thu_tu`, `ngay_bat_dau`, `ngay_ket_thuc`, `created_at`) VALUES
(1, 'ƯU ĐÃI MÙA HÈ', 'ads_1777399056_343.webp', '', 'banner_top', '', 1, 0, '2026-04-28', '2026-05-15', '2026-04-28 01:25:57'),
(2, 'Cộng đồng', 'ads_1777381799_508.png', '', 'banner_home', '', 1, 0, '2026-04-28', '2026-07-02', '2026-04-28 11:30:03'),
(3, 'ddd', 'ads_1777399356_711.webp', '', 'banner_top', '', 1, 0, NULL, NULL, '2026-04-29 01:02:36'),
(4, 'giay', 'ads_1777399397_854.jpg', '', 'banner_top', '', 1, 0, NULL, NULL, '2026-04-29 01:03:17'),
(5, 'ada', 'ads_1777399435_540.webp', '', 'banner_home', '', 1, 1, NULL, NULL, '2026-04-29 01:03:55'),
(6, 'dđâ', 'ads_1777399545_228.webp', '', 'banner_home', '', 1, 0, NULL, NULL, '2026-04-29 01:05:45'),
(7, 'giay', 'ads_1777399560_840.jpg', '', 'banner_home', '', 1, 0, NULL, NULL, '2026-04-29 01:06:00');
...
(11, 'Máy tính Casio FX570', 550000.00, 41, 'casio-fx-570-ms-may-tinh-ca-nhan-2.jpg', 'Máy tính casio FX 570 VN Plus chính hãng được sản xuất theo công nghệ tiên tiến của Nhật Bản với nhiều tính năng được cải tiến có thể đáp ứng tốt nhất nhu cầu học tập và làm việc của mọi đối tượng khách hàng.', 3, 6, NULL, NULL, 8, 0, 3, 44),
...
(13, 'Máy tính Casio 570 es plus , Độ Chính Xác Cao , Giá Rẻ', 180000.00, 38, 'vn-11134207-820l4-mhzw7lx98nwo89.webp', 'Phiên bản mới này có tổng cộng 521 tính năng, bao gồm tất cả các tính năng của dòng FX-570ES PLUS và rất nhiều tính năng vượt trội mà những dòng máy tính khác trên thị trường chưa có như + Giải phương trình và bất phương trình bậc 4,. ', 3, 6, NULL, NULL, 88, 0, 3, 179),
...
(21, 'Balo Da Công Sở Nam Nữ Thời Trang Sang Trọng Tinh Tế. Balo MINTAS_', 322000.00, 539, 'vn-11134207-820l4-mek3aq1vf4lc5a.webp', 'Thiết kế nhiều ngăn: 1 ngăn chính lớn + 1 ngăn chuyên dụng đựng laptop + 1 ngăn phụ lớn + hệ thống nhiều ngăn phụ nhỏ rộng rãi chứa được rất nhiều đồ mà lại rất gọn gàng', 5, NULL, NULL, NULL, 389, 0, 5, 819),
(22, 'Balo đi học đi làm MOONLAB vải chống nước đựng vừa laptop 15.6inch MS:ML69', 441000.00, 507, 'vn-11134207-81ztc-mkn9gsqm2gw1f2.webp', 'BALO ĐI HỌC ĐI LÀM MOONLAB VẢI CHỐNG NƯỚC ĐỰNG VỪA LAPTOP 15.6INCH', 5, NULL, NULL, NULL, 460, 0, 5, 924),
...
(24, 'Giày vải bata sneaker Thượng Đình KK14-1', 120000.00, 88, '44577210-8934-4623-be7a-e46deb05dec8.webp', ' Giày Vải Bata Sneaker Thượng Đình KK14-1 Ba ta Đá Banh Đế Bằng Học Sinh Đi Làm Chạy Bộ Tập Thể Dục Thể Thao Giá Rẻ Bền. Giày thể thao (vải) đế crepe - sản phẩm chính hãng của Giày Thượng Đình, Việt Nam. ', 6, 5, NULL, NULL, 484, 1, 5, 981),
...
(27, '[DEAL MỞ BÁN] Giày nữ thể thao đễ thương đế nhẹ QCCC full box CAT', 442000.00, 411, 'vn-11134207-7ra0g-m7zll6g4c41ad5.webp', 'Hàng bên shop là hàng QC full box, tuy nhiên do quá trình vận chuyển có thể hộp sẽ bị móp méo, điều này là không tránh khỏi được nên mong quý khách hiểu và thông cảm.', 6, NULL, NULL, NULL, 120, 0, 3, 276),
...
(30, 'Sổ Tay basic khổ A6 A5 B5 A4 Lò Xo 160 trang, kẻ caro, kẻ ngang, trơn BÌA NHỰA CHỐNG THẤM NƯỚC', 17000.00, 296, 'sg-11134253-82620-mk5x5g4zpkp47a.webp', 'Điểm nổi bật không thể bỏ qua! ✨', 7, NULL, NULL, NULL, 112, 0, 3, 170),
...
(34, 'Bút bi Thiên Long TL027', 5000.00, 199, 'artboard_6_993a955c7bc34ed983cf23d627053848.jpg', 'Bút bi Thiên Long TL-027 là một trong những chiếc bút bi được học sinh, sinh viên và dân văn phòng sử dụng rất nhiều tại Việt Nam, bút bi Thiên Long TL-027 có thiết kế tối giản nhưng tinh tế và ấn tượng. Toàn bộ thân bút làm từ nhựa trong, phối hợp hoàn hảo với màu ruột bút.', 8, 1, NULL, NULL, 216, 0, 4, 460),
...
(80, 'Combo 5 Quyển Tập 96 Trang Siêu VIP Thành Đạt - Định Lượng 120gsm , Viết Không Lem - VPP Happy Kids', 42999.00, 7457, 'sg-11134201-7rffd-m9feel7w6hm19a.webp', 'Đảm bảo không lem.', 18, NULL, NULL, NULL, 1078, 0, 3, 183),
...
(108, 'Balo Cho Bé Mầm Non Hình Thỏ Tai Dài Viền Be Bibo\'s Chống Thấm Nước Cặp Cho Bé Mẫu Giáo 1-6 Tuổi', 249000.00, 36, 'vn-11134207-820l4-mimhj7us48hv77.webp', 'Balo cho bé chống thấm nước hình thú lấy cảm hứng từ động vật gần gũi với thiên nhiên, giúp con có thể hóa thân thành động vật dấn thân vào sự kì bí của núi rừng, bắt đầu một hành trình khám phá đầy thử thách. Sản phẩm được thiết kế với tiêu chuẩn thủ công cao, chú trọng đến từng chi tiết, không chỉ mang đến trải nghiệm nhẹ nhàng và thoải mái khi đeo mà còn bảo vệ vai và cột sống trẻ phát triển tốt nhất.', 5, NULL, NULL, NULL, 15, 1, 5, 0),
...
(2, 'KM2026', 'Khuyến mãiiiii', 2, 1, 15, 0, 0, 1, 100, '2026-04-23 00:57:00', '2026-07-02 00:57:00'),
(3, '12WQE', 'Khuyến mãiiiii muaf egef', 2, 1, 14, 0, 0, 1, 0, '2026-06-11 11:57:00', '2026-06-30 11:57:00');
...
--
ALTER TABLE `danhmuc`
  MODIFY `madanhmuc` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `dathang`
--
ALTER TABLE `dathang`
  MODIFY `madh` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `hoadon`
  MODIFY `mahoadon` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `khachhang`
--
ALTER TABLE `khachhang`
  MODIFY `makh` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
